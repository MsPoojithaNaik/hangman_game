# simple hangman game using turtle graphics
...
wordbank = ['apple','banana','mango','fig','guava','grapes','orange','chikku','pappaya','kiwi']
...
while not bored:
    ...
    while wrong < 6 and not terminate:
        letter = turtle.textinput('Hangman Game: Fruits Edition','Guess a letter:')
        turtle.goto(-135,-35)
